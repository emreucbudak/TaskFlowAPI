...
static async Task EnsureProjectManagementReferenceDataSeededAsync(IServiceProvider services)
{
    ...
    {
        new ProjectManagement.Domain.Entities.TaskStatus { TaskStatusId = 1, StatusName = "G�rev Atamas� Yap�ld�" },
        new ProjectManagement.Domain.Entities.TaskStatus { TaskStatusId = 2, StatusName = "Yap�m A�amas�nda" },
        new ProjectManagement.Domain.Entities.TaskStatus { TaskStatusId = 3, StatusName = "Onay Bekliyor" },
        new ProjectManagement.Domain.Entities.TaskStatus { TaskStatusId = 4, StatusName = "Tamamland�" }
    };

    var requiredPriorities = new[]
    {
        new ProjectManagement.Domain.Entities.TaskPriorityCategory { TaskPriorityCategoryId = 1, CategoryName = "�ncelikli G�rev" },
        new ProjectManagement.Domain.Entities.TaskPriorityCategory { TaskPriorityCategoryId = 2, CategoryName = "S�radan G�rev" },
        new ProjectManagement.Domain.Entities.TaskPriorityCategory { TaskPriorityCategoryId = 3, CategoryName = "Acil G�rev" }
    };
