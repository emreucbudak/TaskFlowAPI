    ...
    public partial class Initial_Identity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupRoles", x => x.GroupRolesId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupsMembers", x => x.GroupsMemberId);
                    table.ForeignKey(
                        name: "FK_GroupsMembers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupsMembers_GroupRoles_GroupRolesId",
                        column: x => x.GroupRolesId,
                        principalSchema: "Identity",
                        principalTable: "GroupRoles",
                        principalColumn: "GroupRolesId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupsMembers_GroupRolesId",
                schema: "Identity",
                table: "GroupsMembers",
                column: "GroupRolesId");
